 			...
 			<table id="table">
			 	...
			 	<tr>
			 		...
			 		<td id="border">${vo.name }</td>
			 	 	...
			 	 	<tr>
			 		<td id="border">이메일</td>
			 		<td id="border"><input type="text" name = "email" value="${vo.email }"></td>
			 	</tr>
			 	 	<tr>
			 		...
			 		<td id="border">
						...
						-<input type="text" size = "5" maxlength="4" value="${vo.tel2 }" name = "tel2">
						-<input type="text" size = "5" maxlength="4" value="${vo.tel3 }" name = "tel3">
					</td>
			 	</tr>
			 	<tr>
