...
num1 = 30 * 2;  // 변수가 담고 있는 값은 변경될수 있다. (그래서 변수다!)
console.log('num1 =', num1);

let num2;   // 한번도 대입하지 않은 (초기화되지 않은)변수는 undefined 값을 가진다.
...
console.log('PI =', PI);
// PI = 123;
// const K;  // JS 에선 상수 선언과 동시에 초기화 해야 한다!
...
// 바깥쪽 scope 에서 선언된 변수는 안쪽에서 선언된 변수에서 사용 가능
// 안쪽에서 동일한 이름으로 선언된 변수가 있으면, 해당변수로 동작.
let grade = 4;
let age = 1;
{
    let age = 2;
