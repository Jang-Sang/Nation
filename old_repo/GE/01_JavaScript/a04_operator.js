...
console.log(12.1 % 3);   /// 0.09999999999999964  ! 실수연산 결과는 정밀도의 한계가 있다!
...
num4 = 100;
num5 = ++num4;  // 대입연산 = 을 수행하기 전에 ++ 연산 수행
console.log('num4 =', num4, 'num5 =', num5);

num4 = 100;
num5 = num4++;  // 대입연산 = 먼저 수행한 뒤에 ++ 연산 수행
console.log('num4 =', num4, 'num5 =', num5);

num10 = 10;
num11 = num10-- + 5;
console.log('num10 =', num10, 'num11 =', num11);

// *위와 같이 연산식 안에 증감연산자 사용은 피하자* (비추)
...
console.log(10 == "10"); // ==  는 '값' 만 비교
console.log(10 === "10");  // '값' + '타입' 까지 비교

// 실수연산 결과는 오차발생 가능!  연산결과로 비교연산 하지 말자!
num1 = 3.2
num2 = 12.3 / 4.1 + 0.2;  // 3.2 ?
console.log(num1 == num2);  // false 헉!?!?
console.log('num1 =', num1);
...
console.log(num3 << 2);   // 40

// num1 * 2 보다 num1 << 1 하는게 몇십배 속도 빠름.
